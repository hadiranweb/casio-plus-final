...
const statusLabels: Record<string, () => string> = {
  ...
  ready_for_approval: m.shared_status_ready_for_approval,
  ready_for_review: m.shared_status_ready_for_review,
  ...
  sync_queued: m.shared_status_sync_queued,
